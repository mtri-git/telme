        ...
        <div className="space-y-3 sm:space-y-4">
          {loading && chatRooms.length === 0 ? (
            ...
            chatRooms.map((room) => (
              <div
                key={room._id}
                className="p-4 sm:p-5 rounded-xl border border-border bg-card hover:bg-muted transition-colors flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3"
              >
                ...
                <Button
                  className={`px-4 sm:px-6 py-2 rounded-full w-full sm:w-auto flex-shrink-0 ${
                    room.is_member 
            ...
            <div className="flex flex-col items-center justify-center bg-card rounded-xl p-8 sm:p-12 border border-border">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 sm:h-16 sm:w-16 text-muted mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
